 ...
 **/
KISSY.add(function (S, Node, RichBase,JSON,UA,IframeType, AjaxType, FlashType, HtmlButton, SwfButton, Queue, AgileDialog) {
    ...
    return Uploader;
}, {requires:['node', 'rich-base','json', 'ua','./type/iframe', './type/ajax', './type/flash', './button/base', './button/swfButton', './queue', 'kg/agiledialog/1.0.2/index']});
/**
 * changes:
 * 明河：1.5
 *          - [-] 删除_oldInput
